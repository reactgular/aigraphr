...
export class Update1736001087390 implements MigrationInterface {
    name = 'Update1736001087390';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "temporary_nodes" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "workspaceId" integer NOT NULL, "type" varchar NOT NULL, "name" varchar(128) NOT NULL, CONSTRAINT "FK_b7a7995260152c818f25becfcc5" FOREIGN KEY ("workspaceId") REFERENCES "workspaces" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
        );
        await queryRunner.query(
            `INSERT INTO "temporary_nodes"("id", "workspaceId", "type") SELECT "id", "workspaceId", "type" FROM "nodes"`
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `INSERT INTO "nodes"("id", "workspaceId", "type") SELECT "id", "workspaceId", "type" FROM "temporary_nodes"`
        );
